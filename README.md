        ...
        < div  class = " menu-logo " >
            < div  class = " navbar-brand " >
                < span  class = " navbar-logo " >
                    < Un  href = " inicio.html " >
                         < img  src = " assets / images / logo-2-122x54.png "  alt = " Mobirise "  title = " "  style = " height: 3.8rem; " >
                    </ a >
                </ span >
...
< Sección de  clase = " motor " > < un  href = " https://mobiri.se/e " > cómo hacer una página web gratis </ a > </ sección > < sección de  clase = " cid-qTkA127IK8 mbr-pantalla completa mbr-parallax-background "  id = " header2-1 " >
...
< section  class = " cid-qYzaJ0yzRL "  id = " footer1-4x " >
